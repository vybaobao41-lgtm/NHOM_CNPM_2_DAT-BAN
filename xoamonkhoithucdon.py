...
class XoaMonGUI:
    ...
    def tai_du_lieu(self):
        if not os.path.exists(FILE_THUCDON):
            messagebox.showerror("Lỗi", "Không tìm thấy file THUCDON.json")
            return

        with open(FILE_THUCDON, "r", encoding="utf-8") as f:
    ...
    def xoa_mon(self):
        ...
        try:
            ...
            with open(FILE_THUCDON, "w", encoding="utf-8") as f:
